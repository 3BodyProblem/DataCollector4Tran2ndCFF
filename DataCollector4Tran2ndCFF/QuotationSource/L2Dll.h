...
public:
	...
	//获取码表[2,2]
	int		GetNameTable( unsigned short dwStartNo, tagCcComm_CffexNameTable *, int nCount );

	//获取个股行情[2,13]
	int		GetStock( unsigned short dwStartNo, tagCcComm_CffexStockDataEx *, int nCount );
