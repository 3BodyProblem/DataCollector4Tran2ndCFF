...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int	L2Dll::GetNameTable( unsigned short dwStartNo, tagCcComm_CffexNameTable * pValue, int nCount )
{
	assert( pValue != NULL && nCount > 0 );

	return GetData( 2, 100, dwStartNo, pValue, nCount*sizeof(tagCcComm_CffexNameTable), sizeof(tagCcComm_CffexNameTable) );
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int L2Dll::GetStock( unsigned short dwStartNo, tagCcComm_CffexStockDataEx * pValue, int nCount )
{
	assert( pValue != NULL && nCount > 0 );
	
	return GetData( 2, 102, dwStartNo, pValue, nCount*sizeof(tagCcComm_CffexStockDataEx), sizeof(tagCcComm_CffexStockDataEx) );
}
